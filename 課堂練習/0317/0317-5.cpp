...
int main()
{
  ...
  ifstream fin("/Users/shengfu/Desktop/臺大/資料結構與進階程式設計 陳炳宇/資料結構與與進階程式設計 程式碼/MyVector.txt");
  ofstream fout("/Users/shengfu/Desktop/臺大/資料結構與進階程式設計 陳炳宇/資料結構與與進階程式設計 程式碼/out.txt");
